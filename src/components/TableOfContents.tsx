...
export function TableOfContents({ activeSection }: TableOfContentsProps) {
  ...
  const sections = [
    { id: 'portal-journey', label: 'Portal Journey', number: '0.0' },
    ...
    { id: 'case-atlas', label: '4.1 Cases and Policy', number: '4.1' },
    { id: 'resource-library', label: 'Resource Library', number: 'R' },
